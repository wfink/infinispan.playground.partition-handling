...
@ApplicationScoped
public class PHDistCacheManagerProvider {
	private static final String CONFIG = "distPHcache-config.xml";
	private static final Logger log = Logger.getLogger(PHDistCacheManagerProvider.class.getName());
